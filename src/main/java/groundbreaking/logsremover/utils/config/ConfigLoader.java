package groundbreaking.logsremover.utils.config;
...
public final class ConfigLoader {
    ...
    public ConfigLoader(final LogsRemover plugin) {
        this.plugin = plugin;
    }
    ...
    private FileConfiguration checkVersion(final FileConfiguration config, final String fileName, final double fileVersion) {
        final double configVersion = config.getDouble("config-version", 0);
